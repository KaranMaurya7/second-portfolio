...
export function Navbar({ secContact, setSecContact }) {
    return (<>
        <nav className='fixed duration-300 transition-all left-[1vw] shadow-md top-[89vh] w-[98%] m-auto rounded-xl bg-white p-2 py-5 opacity-80  md:w-1/2 z-20 md:left-1/4 lg:left-[23%] lg:top-4 lg:h-16 lg:w-[60%]'>
            <ul className='flex h-full px-2 flex-row justify-evenly  lg:flex-row'>
                ...
                <li className=' cursor-pointer duration-300 transition-all bottom-1'>
                    ...
                    <a href='#projects'>
                        <img className='w-6 hover:scale-[1.2] lg:hidden inline
            \7 cursor-pointer' src='https://cdn-icons-png.flaticon.com/128/4594/4594446.png' alt='icon' />
                ...
                <li className=' cursor-pointer duration-300 transition-all'>
                    ...
                    <a href='#projects'>
                        <img className='w-6 hover:scale-[1.2] lg:hidden inline
            \7 cursor-pointer' src='https://cdn-icons-png.flaticon.com/128/2717/2717499.png' alt='icon' />
                ...
                <li onClick={() => setSecContact(!secContact)} className=' cursor-pointer duration-300 transition-all'>
                    ...
                    <img className='w-6 hover:scale-[1.2] lg:hidden inline
            \7 cursor-pointer' src='https://cdn-icons-png.flaticon.com/128/9374/9374883.png' alt='icon' />
                ...
                <li className=' cursor-pointer duration-300 transition-all'>
                    ...
                    <a href='#projects'>
                        <img className='w-6 hover:scale-[1.2] lg:hidden inline
            \7 cursor-pointer' src='https://cdn-icons-png.flaticon.com/128/1091/1091007.png' alt='icon' />
